...
- Q3 (19/20)
	...
	**Q3.4: In terms of the first output, should stress on "display the information of the files in the ~/mimic/hosp folder that start with a, l, or pa and end with .gz."** (-1 pt)
...
-   [Rule 2.6](https://style.tidyverse.org/syntax.html#long-function-calls) The maximum line length is 80 characters. Long URLs and strings are exceptions.  
    ...
    **Line 111, 117, 121, 130, 134, 138, 142, 155, **
