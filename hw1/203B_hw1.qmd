...
**Solution: The compressed labevents file has 2592909134 bytes(2.41 GB) and takes 0.002 seconds to run, while the uncompressed labevents file has 9624879104 bytes(8.86 GB) and takes 12.788 seconds to run.**
...
Here is the ![screenshot](Q6_screenshot.png). 
